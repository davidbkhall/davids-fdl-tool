...
from fdl.errors import UnknownHandlerError
...
class PluginRegistry:
    ...
    def load_builtin(self):
        ...
        for module in resources.files(anchor).iterdir():
            if module.name.startswith("_") or not module.name.endswith(".py"):
                continue
            module_name = module.name.removesuffix(".py")
    ...
    def load_plugins(self):
        """
        Load plugins from the "fdl.plugins" namespace.
        """
        plugin_packages = entry_points(group="fdl.plugins")
    ...
    def get_handler_by_name(self, handler_name: str, func_name: str) -> Any:
        """
    ...
    def get_handler_by_suffix(self, suffix: str, func_name: str) -> Any:
        """
