        ...
        Form {
            ...
            Section("Effective Dimensions") {
                ...
                HStack {
                    ...
                    Spacer()
                    TextField("X", value: $effectiveAnchorX, format: .number)
                        .textFieldStyle(.roundedBorder)
                        .frame(width: 80)
                    TextField("Y", value: $effectiveAnchorY, format: .number)
                        .textFieldStyle(.roundedBorder)
                        .frame(width: 80)
                }
            }
            ...
            Section("Photosite Dimensions") {
                ...
                HStack {
                    Text("Anchor")
                        .foregroundStyle(.secondary)
                    Spacer()
                    TextField("X", value: $photositeAnchorX, format: .number)
                        .textFieldStyle(.roundedBorder)
                        .frame(width: 80)
                    TextField("Y", value: $photositeAnchorY, format: .number)
                        .textFieldStyle(.roundedBorder)
                        .frame(width: 80)
                }
            }
